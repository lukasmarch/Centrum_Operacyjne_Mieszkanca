...
SOURCES = [
    {
        ...
        "type": "rss",
        "url": "https://rss.energa-operator.pl/rss/wylaczenia_biezace?id=5",
        "config": {"keyword_filter": POWIAT_KEYWORDS},
    },
    {
        "name": "Energa - wyłączenia planowane (RSS)",
        "type": "rss",
        "url": "https://rss.energa-operator.pl/rss/wylaczenia_planowane?id=5",
        "config": {"keyword_filter": POWIAT_KEYWORDS},
    },
    {
