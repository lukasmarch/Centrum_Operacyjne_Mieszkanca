...
DATE_CASES = [
    ...
    ("łamanie wiersza między datą a godziną to nie koniec zdania ← 5770 w bazie",
     "HDK PCK zaprasza.\n📅 16 września 2026 r.\n⏰ godz. 8:00–11:30\n📍 Rybno",
     datetime(2026, 9, 2, 13, 44), datetime(2026, 9, 16, 6, 0), datetime(2026, 9, 16, 9, 30)),
    ("nowa linia i litera = nowe zdanie, godziny z niego nie liczą się",
     "Zebranie 10 września\nBiuro czynne w godzinach 7:30-15:30",
