"""
Newsletter scheduler jobs - Weekly (Saturday 10:00) and Daily (Mon-Fri 6:30)
"""
...
from src.database import (
    engine, NewsletterSubscriber, NewsletterLog, User,
...
async def send_weekly_newsletter():
    ...
    async with async_session() as session:
        ...
        # Generate newsletter content once (same for all free tier)
        try:
