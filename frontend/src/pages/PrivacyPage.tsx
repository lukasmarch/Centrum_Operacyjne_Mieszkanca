...
const PrivacyPage: React.FC<PrivacyPageProps> = ({ onNavigate }) => (
  <LegalLayout title="Polityka prywatności" updated="7 lipca 2026">
    ...
    <p>Administratorem danych osobowych jest <strong>Lumargo Łukasz Marchlewicz</strong>, NIP: 571-156-78-15, adres: Żabiny 96, 13-220 Rybno (dalej: „Administrator"). Kontakt we wszystkich sprawach dotyczących danych osobowych: <strong>biuro@lumargo.pl</strong>, tel. <strong>+48 501 081 723</strong>.</p>
