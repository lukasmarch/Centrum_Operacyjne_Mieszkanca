...
interface GlowingShadowButtonProps {
  ...
  borderRadius?: string; // dodane, default 1rem
  blurModifier?: number; // dodane, służy do kontrolowania siły rozmycia
}

export function GlowingShadow({ children, className = "", borderRadius = "1rem", blurModifier = 1 }: GlowingShadowButtonProps) {
    ...
    <>
      <style>{`
        ...
        .glow-content:before {
          ...
          border-radius: calc(var(--card-radius) * 0.9);
          box-shadow: 0 0 ${20 * blurModifier}px black;
