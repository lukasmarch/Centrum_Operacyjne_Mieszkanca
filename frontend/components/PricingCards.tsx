...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'Podstawowe dane GUS (8 zmiennych)' },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: '39 zmiennych GUS', tooltip: 'Szczegółowe dane: demografia, rynek pracy, finanse gminy, mieszkalnictwo, edukacja, zdrowie' },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '55 zmiennych GUS', tooltip: 'Kompletne dane statystyczne Gminy Rybno' },
