...
const SourceChip: React.FC<SourceChipProps> = ({ source }) => (
  <a
    ...
    className="inline-flex items-center gap-1.5 text-[11px] text-neutral-400 hover:text-blue-400 bg-gray-900/60 border border-white/5 hover:border-blue-500/30 px-2.5 py-1 rounded-full transition-all"
  >
